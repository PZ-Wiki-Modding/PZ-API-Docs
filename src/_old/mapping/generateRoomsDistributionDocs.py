...
def generate_distributions_docs():
    ...
    distributions_json_path = repo_root / "external" / "pz-lua-parser" / "out" / "distributions.json"
    procedural_json_path = repo_root / "external" / "pz-lua-parser" / "out" / "procedural_distributions.json"
